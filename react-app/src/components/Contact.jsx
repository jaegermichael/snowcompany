          ...
          <div className="lg:col-span-2 space-y-0">
            <div className="bg-navy p-8 rounded-t-xl text-white">
              ...
              <div className="space-y-5">
                <a href="tel:+263771234567" className="flex items-center gap-4 group">
                  ...
                  <div><p className="text-white/40 text-[10px] uppercase tracking-wider">Phone</p><p className="font-semibold text-sm">+263 77 123 4567</p></div>
                </a>
                <a href="https://wa.me/263771234567" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 group">
                  ...
                  <div><p className="text-white/40 text-[10px] uppercase tracking-wider">WhatsApp</p><p className="font-semibold text-sm">+263 77 123 4567</p></div>
                </a>
