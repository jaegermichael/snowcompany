    ...
    <footer className="bg-navy text-white">
      <div className="max-w-7xl mx-auto px-4 lg:px-8 pt-16 pb-8">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          <div>
            ...
            <div className="flex gap-2">
              ...
              <a href="https://wa.me/263771234567" className="w-9 h-9 bg-white/5 hover:bg-green-500 rounded-lg flex items-center justify-center transition"><i className="fab fa-whatsapp text-sm"></i></a>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-white/30 text-sm">&copy; 2025 Frozen Solutions Zimbabwe. All rights reserved.</p>
