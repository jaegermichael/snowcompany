      ...
      <div className="bg-navy text-white/80 text-xs hidden md:block">
        <div className="max-w-7xl mx-auto px-4 lg:px-8 flex items-center justify-between h-10">
          <div className="flex items-center gap-6">
            ...
            <a href="tel:+263776146858" className="hover:text-ice transition flex items-center gap-1.5">
              <i className="fas fa-phone text-ice text-[10px]"></i> +263 77 614 6858
            </a>
          </div>
          <div className="flex items-center gap-4">
            ...
            <div className="flex gap-2.5">
              ...
              <a href="https://wa.me/263776146858" className="hover:text-ice transition"><i className="fab fa-whatsapp"></i></a>
            </div>
          </div>
        </div>
      </div>
